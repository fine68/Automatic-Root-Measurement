...
import sys
sys.path.append('/openbayes/home/Torch-Pruning-master/')
...
def prune(args):
    ...
    pruning_cfg['data'] = "ultralytics/datasets/VOC.yaml"
    pruning_cfg['epochs'] = 20
    ...
    base_macs, base_nparams = tp.utils.op_counter.count_ops_and_params(model.model, example_inputs)
    # base_macs, base_nparams = count_ops_and_params(model.model, example_inputs)
    # tp.utils.op_counter.cou
    ...
    for i in range(args.iterative_steps):
        ...
        pruner = tp.pruner.algorithms.GroupNormPruner(
            model.model,
            example_inputs,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='weight/peas_root.pt', help='Pretrained pruning target model file')
    parser.add_argument('--cfg', default='ultralytics/yolo/cfg/default.yaml',
